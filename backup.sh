...
[[ $BACKUPDIR =~ ^[a-zA-Z]: ]] || die "Usage:\n\t$0 Drive:\\full-path-of-backup-dir mapDriveLetter:"
[[ $MAPDRIVE =~ ^[a-zA-Z]: ]] || die "Usage:\n\t$0 Drive:\\full-path-of-backup-dir mapDriveLetter:"

BUDIR="$(cygpath "$MAPDRIVE")"

[[ -d "$BUDIR" ]] || die "The directory $MAPDRIVE ($BUDIR)doesn't exist"
...
${RSYNC} -rlitzvvhR $OPTIONS $FMT $EXC $BUDIR/./ $BACKUPURL/$RID/current/$BPATH
