...
my %obj = (
  Win32_OperatingSystem => [qw|BootDevice BuildNumber BuildType Caption CodeSet CountryCode CSName Locale Name 
    OperatingSystemSKU OSArchitecture OSLanguage OSProductSuite OSType ProductType SerialNumber ServicePackMajorVersion 
